...
function DNUI_display_menu()
{
    ...
    <h1>DEPRECATED</h1>
    <p><b>This plugin is not longer maintained, you can see the new dev at <a
                    href="https://wordpress.org/plugins/ultimate-media-cleaner">Ultimate media cleaner</a></b></p>
    ...
    <div ng-app="dnuiPlugin">
        ...
        <div ng-controller="DnuiCtrl">
            ...
            <uib-tabset>
                ...
                <uib-tab select='tabBackups()'
                         heading="<?php _e('Backups', 'dnui-delete-not-used-image-wordpress'); ?>">
                    <h1>
                ...
                <uib-tab select='tabOptions()'
                         heading="<?php _e('Options', 'dnui-delete-not-used-image-wordpress'); ?>">
                    <h1>
