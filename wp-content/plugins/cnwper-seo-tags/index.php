...
Plugin URI: https://www.laobuluo.com/3623.html
Description: WordPress自动关键字插件（CNWPer SEO Tags）,能够实现TAGS关键字内链、自动分布到匹配文章，以及可以批量分布管理关键字。公众号： <font color="red">站长事儿</font>
Version: 2.3
Author: 老部落
Author URI: https://www.laobuluo.com/
Requires PHP: 7.0
 */
define('CNWPER_SEO_TAGS_VERSION', 2.1);
...
function cnwper_seo_tags_setting_page(){
   ...
   <div class="container-laobuluo-main">
    <div class="laobuluo-wbs-header" style="margin-bottom: 15px;">
              <div class="laobuluo-wbs-logo"><a><img src="<?php echo plugin_dir_url( __FILE__ );?>layui/images/logo.png"></a><span class="wbs-span">WordPress自动内链关键字插件</span><span class="wbs-free">Free V2.3</span></div>
             <div class="laobuluo-wbs-btn">
                  <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-home"></i> 插件主页</a>
                  <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/3623.html?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-release"></i> 插件教程</a>
             </div>
        </div>
    </div>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    ...
                    <div class="laobuluo-links">
                        <a href="https://www.laobuluo.com/?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=footer"  target="_blank">插件官方</a>
                        <a href="https://www.laobuluo.com/donate/?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=footer"  target="_blank">赞助插件</a>
                        <a href="https://www.laobuluo.com/3623.html?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=footer"  target="_blank">使用说明</a> 
                        <a href="https://www.laobuluo.com/about/?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=footer"  target="_blank">关于我们</a>
                        </div>
...
function cnwper_seo_tags_batch_set_tags_page(){
   ...
   <div class="container-laobuluo-main">
    <div class="laobuluo-wbs-header" style="margin-bottom: 15px;">
              <div class="laobuluo-wbs-logo"><a><img src="<?php echo plugin_dir_url( __FILE__ );?>layui/images/logo.png"></a><span class="wbs-span">WordPress自动内链关键字插件</span><span class="wbs-free">Free V2.1</span></div>
             <div class="laobuluo-wbs-btn">
                  <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-home"></i> 插件主页</a>
                  <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/3623.html?utm_source=cnwperseotags-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-release"></i> 插件教程</a>
             </div>
                    ...
                    <div class="layui-col-md3">
                        <div  id="nav">
                            ...
                            <div class="laobuluo-panel">
                                ...
                                <div class="laobuluo-code">
                                    <img src="<?php echo plugin_dir_url( __FILE__ );?>layui/images/qrcode.png">
                                    <p>微信扫码关注 <span class="layui-badge layui-bg-blue">老蒋部落</span> 公众号</p>
                                    <p><span class="layui-badge">优先</span> 获取插件更新 和 更多 <span class="layui-badge layui-bg-green">免费插件</span> </p>
                                </div>
                            </div>
